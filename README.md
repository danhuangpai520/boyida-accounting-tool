...
- 2026-06-24 起，本项目采用 T0 主控 + T2/T3/T4/T8 等模块 worker 真正执行的协作方式：T0 负责边界、冲突合并和最终审计；T2/T3/T4/T8 在各自授权范围内落地实现、文档、安全扫描和验证证据。后续任何模块变更都必须同步到本文件、公开执行规范、公开复刻文档、公开源码索引、版本历史和使用说明。
...
- `做账执行工具.exe` SHA256：`9515D9709BF46742C734620E5859FEB7B06D06F2D6CA883DA18FBCFD27CC2AFD`
- `项目资料\安装包\输出\BoyidaAccountingTool_Setup_v2.3.exe` SHA256：`2DE43A349C9645552915FED807112A05A8E2BC9F55E9EBDB6C951CBF5DE32292`
